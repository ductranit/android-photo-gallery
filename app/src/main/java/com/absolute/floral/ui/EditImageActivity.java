...
import com.absolute.floral.util.FileUtils;
...
public class EditImageActivity extends AppCompatActivity {
    ...
    public static final int EDIT_IMAGE_REQUEST_CODE = 70;
...
//        }
        ...
        outputPath = FileUtils.genEditFile().getAbsolutePath();
...
//                        | View.SYSTEM_UI_FLAG_IMMERSIVE);
    ...
    private void startEditImage() {
        try{
            Intent i = new ImageEditorIntentBuilder(this, imagePath, outputPath)
            ...
            iamutkarshtiwari.github.io.ananas.editimage.EditImageActivity.start(this, i, EDIT_IMAGE_REQUEST_CODE);
...
//                break;
            case EDIT_IMAGE_REQUEST_CODE:
                ...
                boolean isImageEdit = data.getBooleanExtra(iamutkarshtiwari.github.io.ananas.editimage.EditImageActivity.IS_IMAGE_EDITED, false);
                if(isImageEdit) {
                    saveImage(newFilePath);
                } else {
                    Intent resultIntent = new Intent();
                    resultIntent.putExtra(ImageEditorIntentBuilder.OUTPUT_PATH, newFilePath);
        ...
        AsyncTask.execute(() -> {
            try {
                ...
                EditImageActivity.this.runOnUiThread(() -> {
                    ...
                    Intent resultIntent = new Intent();
                    resultIntent.putExtra(ImageEditorIntentBuilder.OUTPUT_PATH, newPath);
                    setResult(RESULT_OK, resultIntent);
                    finish();
                });
            } catch (Exception e) {
